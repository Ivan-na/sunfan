package com.sunfan.monitor.baseUtil;
...
//        mapper.setDeserializerProvider(new StdDeserializerProvider(JsonUtil.getCustomDeserializerFactory())); 
//        mapper.setSerializerFactory(JsonUtil.getSerializerFactory());
    }
